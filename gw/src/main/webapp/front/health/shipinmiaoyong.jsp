				...
				$("#demo1").paginate({
					...
					onChange:function(p){
						if(/msie/.test(navigator.userAgent.toLowerCase())){
				   			...
				   			window.location.href=basePath+"front/health/shipinmiaoyong.jsp?type=2&rows=9&page="+p;
						}else{
							window.location.href="front/health/shipinmiaoyong.jsp?type=2&rows=9&page="+p;
						}
					}
				});
...
<div class="articlet">
			...
			<img id="shihsangshenghuoimg"alt="" src="front/images/health/health_0000s_0000s_0000s_0000_you.png">
			</div>
			<div id="shipinmiaoyong" class="articletitle">&nbsp;&nbsp;&nbsp;&nbsp;食品妙用
			<img id="shipinmiaoyongimg" alt="" src="front/images/health/health_0000s_0000s_0001s_0000_xia.png">
			</div>
			</div>
<div  id="in0" class="in">
		<a id="az0" class="az"></a>
