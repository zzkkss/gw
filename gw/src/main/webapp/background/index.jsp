...
<%--加载JQuery--%>
<script type="text/javascript" src="jscss/js/jquery-1.9.1.min.js"></script>

<script type="text/javascript">
$(function() {
	 $("#indexRight").css("height",$(window).height()-120+70);
	 $("#indexLeft").css("height",$(window).height()-122);
...
<!-- 头文件 header -->
	...
	<div class="area top" id="header">
		...
		<div id="huany">欢迎登录果园老农后台管理系统</div>
...
<!-- top结束 -->
<!-- left -->
<iframe id="indexLeft" name="indexLeft" src="background/left.jsp" frameborder="0"  allowtransparency style="width: 160px; position: absolute;top:122px;left:0px;border: none;" ></iframe>
<!-- left结束 -->
<!-- right -->
